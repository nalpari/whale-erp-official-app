...
| Phase | 내용 | 상태 |
|-------|------|------|
| Phase 1 | 타입 정의 + API 함수 | ✅ 완료 |
| Phase 2 | React Query 훅 + Zustand 스토어 | ✅ 완료 |
| Phase 3 | 목록 + 검색 API 연동 | ✅ 완료 |
| Phase 4 | 상세 + 삭제 + 이메일 전송 | ✅ 완료 |
| Phase 5 | 수정 3종 (계약정보/근무시간/급여정보) | ✅ 완료 |
| Phase 6 | 신규 등록 3단계 플로우 | ✅ 완료 |
